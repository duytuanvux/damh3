...
for item in list_individual:
    ...
    cursor.execute(
        "insert into Individual(IID, INAME, ILOCAL, IPOSTION, CREATED, IBENEFIT, AUTHORS, ACCESSIONS) values(%s, %s, %s, %s, %s, %s, %s, %s, %s)",
        (IID, INAME, ILOCAL, IPOSTION, 	CREATED, IBENEFIT, AUTHORS, ACCESSIONS))
